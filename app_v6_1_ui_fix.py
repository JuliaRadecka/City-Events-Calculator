...
def main():
    ...
    with h2:
        try:
            ...
            logo_candidates = [
                "assets/MTC_Live_logo_white.png",
                "MTC_Live_logo_white.png",
                "assets/MTC Live logo white.png",
                "MTC Live logo white.png",
            ...
            for lp in logo_candidates:
                candidates_to_try = [lp, os.path.join(script_dir, lp)]
                for cp in candidates_to_try:
            ...
            if logo_path:
                # Right-align the logo and make it ~50% larger
                _spacer, _logo = st.columns([2, 5])
                with _logo:
                    st.image(logo_path, use_container_width=True)
        except Exception:
            pass

    # Spacer so enlarged logo doesn't visually collide with the next row
